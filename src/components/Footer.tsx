...
import { getAllCategories, SanityCategory } from '@/lib/products'; // Import SanityCategory

const Footer = () => {
  // State to store categories fetched from the database
  const [categories, setCategories] = useState<SanityCategory[]>([]); // Use SanityCategory
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-300">+92 345 3593470</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-300">Info@rkenterpriseshub.com</span>
              </div>
            </div>
