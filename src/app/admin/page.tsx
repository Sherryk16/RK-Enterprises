...
export default function AdminProducts() {
  ...
  const fetchProducts = async () => {
    try {
      // Fetch all products for the admin page by setting a very high limit
      ...
      setProducts(productsData || []); // Ensure products is always an array
    } catch (error) {
      console.error('Error fetching products:', error);
      setProducts([]); // Set to empty array on error to prevent map is not a function
    } finally {
      setLoading(false);
    }
  };
